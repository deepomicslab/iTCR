...
<pre><code class="language-bash">python3 -m iTCR mcr --inputfile tcr_data.pickle --outputdir results/ [options]
</code></pre>
### Paramenters
...
python3 -m iTCR mcr-display --mcr_path mcr.pickle
```
#### Advanced Options
```bash
# Use FDR correction with custom significance threshold
python3 -m iTCR mcr-display --mcr_path mcr.pickle --adjust_method FDR 

# Custom feature pairs
python3 -m iTCR mcr-display --mcr_path mcr.pickle --features "TRAV,TRBV;cdr3A,cdr3B"
```
